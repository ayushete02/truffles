...
const Login = () =>{  
  const [enable, setbtnenable] = useState(false);
...
<Link href={'/dashboard'} className="w-full block text-white bg-[#194BFB] hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Go to Dashboard</Link>
</button>
}
