...
// const AssetTable = ({data}) => {
    ...
    var filter = ''
    var datafilter = data.filter(row => row.status=='sent')
  ...
  return (
    ...
    <caption className="p-5 pb-2 text-lg font-semibold [text-align-last:justify] text-gray-900 bg-white ">
        ...
        <div className="dropdown inline-block relative">
          <button className="flex items-center text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-1.5 mr-2 mb-2 ">
            <Image src={filterico} alt={''} className='mr-2'/>Filters
           
          </button>
          <ul className="dropdown-menu absolute hidden text-gray-700 pt-1 rounded-md border">
            <li><a className="text-gray-900 bg-white  focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium  text-sm px-5 py-1.5 mr-2   block whitespace-no-wrap" href="#">Sent</a></li>
            <li><a className="text-gray-900 bg-white  focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium  text-sm px-5 py-1.5 mr-2   block whitespace-no-wrap" href="#">Accepted</a></li>
            <li><a className="text-gray-900 bg-white  focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium  text-sm px-5 py-1.5 mr-2   block whitespace-no-wrap" href="#">Remove</a></li>
          ...
          {Array.from({ length: totalPages }, (_, index) => index + 1).map(
            (page) => (
              <button
                ...
                className={`px-3 py-2 border rounded-full m-0.5 border-gray-300 text-sm ${
                  currentPage === page
